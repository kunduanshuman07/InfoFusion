    ...
    return (
        <Root>
            <Box className='container'>
                <Card className='card' onClick={()=>handleQuizChoices("Today's Quiz")} style={{backgroundColor:todaysQuiz?"white":"", color:todaysQuiz?"#086D67":""}}>
                    <Typography>Today's Quiz</Typography>
                </Card>
                <Card className='card' onClick={()=>handleQuizChoices("Past Quizzes")} style={{backgroundColor:pastQuiz?"white":"", color:pastQuiz?"#086D67":""}}>
                    <Typography>Past Quizzes</Typography>
                </Card>
                <Card className='card' onClick={()=>handleQuizChoices("Monthly Quiz")} style={{backgroundColor:monthlyQuiz?"white":"", color:monthlyQuiz?"#086D67":""}}>
                    <Typography>Monthly Quiz</Typography>
                </Card>
                <Card className='card' onClick={()=>handleQuizChoices("Weekly Quiz")} style={{backgroundColor:weeklyQuiz?"white":"", color:weeklyQuiz?"#086D67":""}}>
