...
const PlaygroundLanding = () => {
    ...
    return (
        <>
            <Box style={{ display: "flex", flexDirection: "column", boxShadow: "0px 11px 35px 2px rgba(0, 0, 0, 0.14)", width: "90%", marginTop: "10px", borderRadius: "10px", padding: "20px", cursor: "pointer" }}>
                ...
                <Box style={{ display: "flex",flexDirection: "column", marginTop: "-10px", padding: "20px", borderRadius: "20px" }}>
                    ...
                    <Box style={{display: "flex"}}>
                        <Box style={{ margin: "auto", backgroundColor: "#0072e5", borderRadius: "10px", padding: "20px", marginRight: "2px" }}>
                        ...
                        <Box style={{ margin: "auto", backgroundColor: "#0072e5", borderRadius: "10px", padding: "20px", marginLeft: "2px" }}>
                            <Typography style={{ color: "white", fontSize: "16px", textAlign: "center", fontWeight: "bold", textDecoration: "underline" }}>Scorecard</Typography>
                            <Typography style={{ color: "white", fontSize: "11px" }}>Track your progress and review your performance with the "Scorecard" feature. Dive into detailed statistics, including your quiz history, accuracy, and achievements. The Scorecard provides valuable insights to help you improve and celebrate your successes.</Typography>
                        </Box>
                    </Box>
                </Box>
            </Box>
